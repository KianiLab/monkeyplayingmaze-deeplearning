    ...
    try:
        ...
        with open(file_path, 'r', encoding='ascii', errors='surrogateescape') as file:
            ...
            for line in file:
                ...
                # Ensure we have enough parts for prev_x, prev_y, current_x, current_y, next_x, next_y, and dire>
                if len(parts) < 7:
...
mean = [0.24387684, 0.24407003, 0.2296521]
std = [0.2533392, 0.25349778, 0.23862701]
...
class MonkeyMazeDataset(Dataset):
    def __init__(self, image_dir, trajectory_dir, transform=None,feature_means=None, feature_stds=None):
    ...
    def __getitem__(self, idx):
        ...
        if self.feature_means is not None and self.feature_stds is not None:
            features_tensor = (features_tensor - self.feature_means) / self.feature_stds
